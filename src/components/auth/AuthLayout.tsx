      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          <div className="flex items-center">
            <img src="/logo.png" alt="LoadToCash" style={{ height: '48px', width: 'auto', objectFit: 'contain' }} />
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-gray-50 relative overflow-hidden">
        ...
        >
          ...
          <div className="lg:hidden flex items-center gap-2 mb-6">
            <img src="/logo.png" alt="LoadToCash" style={{ height: '36px', width: 'auto', objectFit: 'contain' }} />
          </div>
